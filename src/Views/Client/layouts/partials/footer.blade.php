                ...
                <div class="follow_us">
                    ...
                    <ul>
                        <li><a href="#"><img
                                    ...
                                    data-src="{{ asset('assets/Client/img/twitter_icon.svg') }}" alt=""
                                    class="lazy"></a></li>
                        <li><a href="#"><img
                                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                    data-src="{{ asset('assets/Client/img/facebook_icon.svg') }}" alt=""
                                    class="lazy"></a></li>
                        <li><a href="#"><img
                                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                    data-src="{{ asset('assets/Client/img/instagram_icon.svg') }}" alt=""
                                    class="lazy"></a></li>
                        <li><a href="#"><img
                                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                    data-src="{{ asset('assets/Client/img/youtube_icon.svg') }}" alt=""
                                    class="lazy"></a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <ul class="footer-selector clearfix">
                ...
                <li><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                        data-src="{{ asset('assets/Client/img/cards_all.svg') }}" alt="" width="198"
