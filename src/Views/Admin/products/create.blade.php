                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" id="price_regular" placeholder="Enter price_regular" name="price_regular">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3 mt-3">
                                <label for="price_sale" class="form-label">Price_sale:</label>
                                <input type="text" class="form-control" id="price_sale" rows="4" placeholder="Enter price_sale" name="price_sale">
                            </div>
                        </div>
                    </div>
